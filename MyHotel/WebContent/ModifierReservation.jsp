...
<div class="col-md-8">
	...
	request.setAttribute("idreserv", idreserv);
	...
	String idclient=numchambre+nom+datedebut;
	request.setAttribute("ancienidc", idclient);
	...
	%>
		<form action="TraiteAjoutReservation" method="post">
			...
			<table>
				<tr>
					<td>Nom client: </td>
					<td><input type="text" name="nomclient" value="<%=nom%>"></td>
				</tr>
				<tr>
					<td>Prenom client: </td>
					<td><input type="text" name="prenomclient" value="<%=prenom%>"></td>
				</tr>
				<br>
				<tr>
					<td>Type chambre</td>
				...
				<tr>
					<td>Date debut:  </td>
					<td><input type="text" name="datedebut" value="<%=datedebut%>"></td>
				</tr>
				<br>
				
				<tr>
					<td>Date fin:  </td>
					<td><input type="text" name="datefin" value="<%=datefin%>"></td>
				</tr>
				<br>
				...
				<tr>
					...
					<td><select name="typereservation" value="<%=type%>">
