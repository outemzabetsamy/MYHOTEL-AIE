...
<center>
	<h1>
		<j:out value="Liste des chambres" />
	...
	>
		<thead>
			...
			<tr>
				...
				<th data-field="numetage" data-sortable="true"  data-filter-control="input">Numero Etage</th>
				...
				<th data-field="prix" data-sortable="true"  data-filter-control="select">Prix par nuit</th>
			</tr>
		</thead>
		<tbody>
			...
			<j:forEach var="ch" items="${ls}">
				...
				<td><j:out value="${ch.numeroChambre }"></j:out></td>
				<td><j:out value="${ch.numeroEtage }"></j:out></td>
				<td><j:out value="${ch.typeChambre}"></j:out></td>
				<td><j:out value="${ch.nbPersonne }"></j:out></td>
				<td><j:out value="${ch.prixChambre }"></j:out></td>
...
$('#edit').on('click',function(){
	...
	let nbpers=nbp[0];
	let prixchambre= parseInt(pc[0]);
	console.log(prixchambre);
		 ...
		 $.ajax({
			 ...
			 success: function(data){
				 ...
				 window.location.href="ModifierChambre.jsp?id="+idd+"&numetage="+numetage+"&typechambre="+typechambre+"&nbpers="+nbpers+"&prixchambre="+prixchambre;
			 }
		 }
				 );
