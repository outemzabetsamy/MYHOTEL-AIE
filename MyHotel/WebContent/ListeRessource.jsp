...
<center>
	<h1>
		<j:out value="Liste des ressources" />
	...
	>
		<thead>
			...
			<tr>
				...
				<th data-field="idressource" data-sortable="true" data-filter-control="input" >ID ressource</th>
				<th data-field="nomressource" data-sortable="true" data-filter-control="input" >Nom ressource</th>
				<th data-field="typeressource" data-sortable="true"  data-filter-control="input">Type ressource</th>
				<th data-field="tarif" data-sortable="true"  data-filter-control="select" >Tarif</th>
		...
		<tbody>
			...
			<j:forEach var="ch" items="${ls}">
				...
				<td><j:out value="${ch.idRessource }"></j:out></td>
				<td><j:out value="${ch.nomRessource }"></j:out></td>
				<td><j:out value="${ch.typeRessource}"></j:out></td>
				<td><j:out value="${ch.tarifRessource }"></j:out></td>
	...
	let tarif=nbp[0];
		 ...
		 $.ajax({
			 ...
			 success: function(data){
				 ...
				 window.location.href="ModifierRessource.jsp?idres="+idd+"&nomres="+nomres+"&typeres="+typeres+"&tarif="+tarif;
			 }
		 }
				 );
